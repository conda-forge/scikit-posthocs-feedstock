...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/scikit-posthocs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10920&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scikit-posthocs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scikit-posthocs` can be installed with:

```
conda install scikit-posthocs
```

It is possible to list all of the versions of `scikit-posthocs` available on your platform with:
